    ...
    <AdminLayout>
      <div className="space-y-8 px-1 sm:px-0 pt-14 lg:pt-0">
        ...
        <div className="w-full rounded-2xl overflow-hidden glow-card purple-glow animate-fade-up">
          <img
            src="https://rmetppilvfrxosvxzhgj.supabase.co/storage/v1/object/public/message-attachments/ee1dcb84-1586-4ba1-8929-dee6ed6c8d56/1774659723093_6vluk3_Inserir_um_t_tulo__6_.png"
            alt="Banner"
