                        ...
                        {isLifetimePromoActive ? (
                          <>
                            <div className="flex items-baseline gap-2 justify-end">
                              ...
                              <span className="text-3xl font-black bg-gradient-to-r from-pink-400 to-red-400 bg-clip-text text-transparent">{user?.email?.toLowerCase() === 'wallacesouzasantos@gmail.com' ? 'R$ 29,90' : 'R$ 79,90'}</span>
                            </div>
                            <p className="text-[11px] text-pink-300 font-bold">{user?.email?.toLowerCase() === 'wallacesouzasantos@gmail.com' ? 'economize R$ 118,00' : 'economize R$ 68,00'}</p>
                          </>
                        ) : (
                          <>
                            <span className="text-3xl font-black bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">{user?.email?.toLowerCase() === 'wallacesouzasantos@gmail.com' ? 'R$ 29,90' : 'R$ 147,90'}</span>
