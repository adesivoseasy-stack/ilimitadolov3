            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative my-1">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-card/50 px-3 text-muted-foreground font-display">ou cadastre com</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full h-12 rounded-xl border border-border/40 bg-background/60 hover:bg-background/80 text-foreground font-semibold font-display text-sm transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50"
              >
                {isGoogleLoading ? (
