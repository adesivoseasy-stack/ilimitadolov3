...
export function useCreatePixOrder() {
  ...
  const createOrder = useCallback(async (quantity: number, customer: PixCustomerData, promo?: boolean, lifetime?: boolean, combo?: boolean, comboChampion?: boolean, renewal?: { licenseId: string }, comboAccount?: boolean, manusCredits?: boolean, lifetimeBulk?: boolean, geminiPro?: boolean, seedanceAccount?: boolean, capcutPro?: boolean, lovableAccount?: boolean, planBasico?: boolean, planPlus?: boolean, planPro?: boolean, planFundador?: boolean): Promise<PixOrderData | null> => {
    setIsLoading(true);
    setError(null);
    try {
