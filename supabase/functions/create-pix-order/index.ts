...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (lifetime) {
      ...
      // Promoção relâmpago: R$ 99,90 até 04/06/2026 às 20h, depois R$ 147,90
      quantity = 1
      const LIFETIME_PROMO_END = new Date('2026-06-04T20:00:00-03:00').getTime()
      const isLifetimePromo = Date.now() < LIFETIME_PROMO_END
      totalReais = isLifetimePromo ? 99.90 : 147.90
